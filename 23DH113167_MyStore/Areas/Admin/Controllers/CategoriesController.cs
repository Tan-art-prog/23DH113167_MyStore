...
using _23DH113167_MyStore.Models;

namespace _23DH113167_MyStore.Areas.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest); // mã lỗi 400: thiếu giá trị tuyển vào
            }
        ...
        // POST: lưu dữ liệu nhập vào từ form Createvào DB
